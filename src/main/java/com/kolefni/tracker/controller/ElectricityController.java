...
public class ElectricityController {
    ...
    //TODO: implement separate endpoints for water and electricity calculators with separate controllers
    ...
    @GetMapping("")
    public String showElectricityForm(@ModelAttribute ("electricityDTO") ElectricityDTO electricity,
                                      Model model) {
    ...
    @GetMapping("/{userId}")
    public String listElectricity(@PathVariable Long id,
                                  Model model) {
        List<Electricity> electricityList = electricityService.getElectricityBillsByUserId(id);
        model.addAttribute("electricityList", electricityList);
        System.out.println(electricityList.toString());
        return "ok";
    }
